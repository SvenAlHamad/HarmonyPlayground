...
This demo is about `Arrays`. It features both the array functionality of EC5 and EC6.
 
## Array basics (`ArrayBasics.js`)
...
## Extending the Array class (`ArrayClassExtend.js`)
